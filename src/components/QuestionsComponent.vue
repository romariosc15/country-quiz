...
<template>
  <div v-if="questions.length > 0 && store.state.currentQuestion < questions.length " class="text-[#E2E4F3] text-center">
  ...
  <div v-else-if="store.state.currentQuestion >= questions.length">
